...
void BackGround3::InitBack()
{
	...
	spr1 = ResourceManager :: getSpritePtr("bg31");
	spr2 = ResourceManager :: getSpritePtr("bg32");
	spr3 = ResourceManager :: getSpritePtr("bg33");
	spr4 = ResourceManager :: getSpritePtr("bg34");
	sprNext = ResourceManager :: getSpritePtr("bg31");
...
{
	sprNow->self->RenderEx(0.0f, 0.0f, sprNow->rot, sprNow->length, sprNow->wideth);
	sprNext->RenderEx(0.0f, 0.0f, *rot2, *length2, *wideth2);
}
